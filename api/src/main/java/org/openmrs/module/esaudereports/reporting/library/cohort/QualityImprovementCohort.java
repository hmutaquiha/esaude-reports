...
public class QualityImprovementCohort {
	...
	public CohortDefinition clinicalConsulationsNumerator() {
		...
		cd.addParameter(new Parameter("location", "US", String.class));
		cd.addSearch("INSCRITOS", Mapped.mapStraightThrough(patientsSubscribedInclusionPeriodPreARTSample()));
	...
	public CohortDefinition pregnantSubrcribedOnART() {
		...
		cohort.addParameter(new Parameter("location", "US", String.class));
